		...
		if (1)
		{
			...
			else if (key == ENTER)
			{
				...
				else if (pointer == 18)
				{
					...
					int posStudent = findStudent(myClass,student,posClass);

					if (posStudent != -1)
					{
						viewScoreOfStudent(myClass, posClass, posCourse, posStudent);
					}
					else
					{
						gotoXY(40, 6);
				...
				else if (pointer == 19)
				{
					...
					if (posCourse != -1)
					{
						ExportScoreToFile("ScoreBoard.csv", myClass, posClass, posCourse);
						gotoXY(40, 5);
						cout << "Success!";
					}
					else
				...
				else if (pointer == 21)
				{
					...
					if (posCourse != -1)
					{
						ExportAttendance("Student_asttendance.csv",myClass, posClass, posCourse);
						gotoXY(40, 5);
						cout << "Success!";
					}
					else
		...
		if (1)
		{
			...
			else if (key == ENTER)
			{
				...
				else if (pointer == 1)
				{
					...
					int student = stoi(userLogin.ID);

					int posStudent = findStudent(myClass, student, posClass);

					checkin_Ofcourse(myClass, posClass, posCourse, posStudent, userLogin);
				...
				else if (pointer == 3)
				{
					...
					MyScore(myClass, posClass, posCourse, posStudent, userLogin);
		...
		if (1)
		{
			...
			else if (key == ENTER)
			{
				...
				else if (pointer == 3)
				{
					...
					if (posCourse != -1)
					{
						editAttendance(myClass, posClass, posCourse, userLogin);
					}
					else
					{
						gotoXY(40, 5);
				...
				else if (pointer == 5)
				{
					...
					if (posCourse != -1)
					{
						editGrade(myClass, posClass, posCourse, userLogin);
					}
					else
					{
						gotoXY(40, 5);
